...
def inference(image, nspix, n_iter, fdim=None, color_scale=0.26, pos_scale=2.5, weight=None, enforce_connectivity=True):
    ...
    # si gray scale, répliquer les couches pour avoir size 3 along channel_axis
...
if __name__ == "__main__":
    ...
    np_range = [1000, 800, 600, 500, 400, 450, 325, 275, 200, 150, 100, 50, 25]
    ...
    if (args.image!=None):
        ...
        plt.imsave("results_modelb.png", mark_boundaries(image, label))
